        ...
        <Row gutter={[16, 16]}>
          <Col xs={24} sm={12} lg={12} xl={12}>
            <div className='comprar-info-box'>
              ...
              <Paragraph className='comprar-info-paragraph'>
                Contamos con años de experiencia en el mercado inmobiliario,
                brindando un servicio confiable y transparente a nuestros
                clientes.
              </Paragraph>
            </div>
            <div className='comprar-info-box'>
              ...
              <Paragraph className='comprar-info-paragraph'>
                Ofrecemos una amplia gama de propiedades, desde apartamentos
                modernos hasta casas con encanto, para satisfacer tus
          ...
          <Col xs={24} sm={12} lg={12} xl={12}>
            <div className='comprar-info-box'>
              ...
              <Paragraph className='comprar-info-paragraph'>
                Nuestro equipo de expertos está listo para proporcionarte
                asesoramiento personalizado en cada paso del proceso de compra,
                asegurándonos de que tomes decisiones informadas.
              </Paragraph>
            </div>
            <div className='comprar-info-box'>
              <Title level={3} className='comprar-info-title'>
              ...
              <Paragraph className='comprar-info-paragraph'>
                Garantizamos transacciones seguras y transparentes, trabajando
                para proteger tus intereses y ofreciendo un proceso de compra
                sin complicaciones.
              </Paragraph>
            </div>
          </Col>
              ...
              <Step
                ...
                description={
                  <span style={{ fontSize: '1.1em', textAlign: 'justify' }}>
                    ...
                    hasta encontrar el lugar indicado.
                  </span>
                }
          ...
          <div className='collapse-container'>
              ...
              <Panel
                header={
                  <span style={{ fontSize: '1.1em' }}>
                    ¿Cómo puedo aprovechar al máximo mi tiempo durante la visita
                    a una propiedad?
                  </span>
                }
                key='1'>
            ...
            <Collapse>
              <Panel
                header={
                  <span style={{ fontSize: '1.1em' }}>
                    ¿Qué debo esperar al visitar propiedades?
                  </span>
                }
                key='1'>
                <p style={{ textAlign: 'justify' }}>
            ...
            <Collapse>
              <Panel
                header={
                  <span style={{ fontSize: '1.1em' }}>
                    ¿Cuántas viviendas debo visitar para encontrar la adecuada?
                  </span>
                }
                key='1'>
                <p style={{ textAlign: 'justify' }}>
            ...
            <Collapse>
              <Panel
                header={
                  <span style={{ fontSize: '1.1em' }}>
                    ¿En qué debo fijarme al visitar una propiedad?
                  </span>
                }
                key='1'>
                <p style={{ textAlign: 'justify' }}>
                  ...
                  la distancia desde la propiedad hasta los lugares que visitas
                  más frecuentemente.
                </p>
              </Panel>
            </Collapse>
            ...
            <Collapse>
              <Panel
                header={
                  <span style={{ fontSize: '1.1em' }}>
                    ¿Como sé cuándo negociar y cuándo dejar pasar una oferta?
                  </span>
                }
                key='1'>
                <p style={{ textAlign: 'justify' }}>
