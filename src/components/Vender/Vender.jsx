    ...
    <div className="titulo-container">
      ...
      <p>El compromiso de Sandar Inmuebles es acompañarte y asesorarte en todas las etapas del proceso de venta, para que la venta sea rapida y efectiva.</p>
        ...
        <Step
            ...
            />
            <Step
              title={<span style={{ fontSize: '1.3em', fontFamily: 'Geometos' }}>Financiamiento (si aplica)</span>}
            ...
            />
            <Step
              title={<span style={{ fontSize: '1.3em', fontFamily: 'Geometos' }}>Inspección y Evaluación</span>}
            ...
            />
            <Step
              title={<span style={{ fontSize: '1.3em', fontFamily: 'Geometos' }}>Cierre y Seguimiento Postventa</span>}
        ...
        <div className="collapse-container">
          ...
          <Collapse>
            <Panel header={<span style={{ fontSize: '1em'}}>1.- ¿Que debo incluir en mi oferta de propiedad?</span>} key="1">
          ...
          <Collapse>
            <Panel header={<span style={{ fontSize: '1.1em'}}>2.- ¿Que puedo esperar del cierre?</span>} key="1">
          ...
          <Divider orientation="left"></Divider>
          <Collapse>
            <Panel header={<span style={{ fontSize: '1em'}}>3.- ¿Cuales son los errores mas comunes en los contratos que debo evitar?</span>} key="1">
          ...
          <Divider orientation="left"></Divider>
          <Collapse>
            <Panel header={<span style={{ fontSize: '1.1em' }}>4.- ¿Que tramites hay que hacer para cerrar?</span>} key="1">
          ...
          <Divider orientation="left"></Divider>
          <Collapse>
            <Panel header={<span style={{ fontSize: '1em' }}>5.- ¿Cuales son las contigencias mas comunes durante la oferta de compra?</span>} key="1">
      ...
      <h2 style={{color: 'white',fontFamily: 'Geometos'}}>Aviso de Privacidad</h2>
      <p>
        En Sandar Inmuebles, nos interesa y respetamos tu privacidad por eso nos dedicamos a proteger tus datos personales.
        <br />
      ...
      <p>
        Para obtener más información sobre cómo manejamos tus datos personales, consulta nuestra <a href="/Aboutus">Política de Privacidad</a>.
      </p>
    </div>
  ...
  <div className="titulo-container">
    ...
    <Form form={form} onFinish={onFinish} layout="vertical">
        ...
        <Form.Item
            ...
            name="tipoPropiedad"
            rules={[{ required: true, message: 'Por favor, selecciona el tipo de propiedad' }]}
            labelCol={{ span: 6, style: { fontFamily:'Geometos' } }}
        >
        ...
        <Form.Item label="Mensaje para la solicitud de Venta" name="motivo" rules={[{ required: true, message: 'Por favor, ingresa el motivo de la venta' }]}
